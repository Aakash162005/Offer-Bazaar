...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li>
                <a href="admin_Home.html" class="active">
                    <i class="fas fa-home"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li>
                <a href="adminApproved.jsp">
    ...
    <%
        ...
        while(rs.next())
        {
        	int aId = rs.getInt(10);
        	PreparedStatement ps1 = con.prepareStatement("select * from advertiserreg where aId = ?");
        	ps1.setInt(1, aId);
    ...
    %>
    	 ...
    	 <!-- Offer 1 -->
                        <tr>
                            ...
                            <td class="date-cell"><%=rs1.getString(3) %></td>
                            <td class="date-cell"><%=rs.getString(7)%></td>
