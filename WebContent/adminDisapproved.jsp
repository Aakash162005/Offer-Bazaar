...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="adminDisapproved.jsp" class="active" >
                ...
                <table>
                    ...
                    %>
                        <tr>
                            ...
                            <td>
  								<a href="Disapproved.jsp?aId=<%=rs.getInt(1)%>">
  							  <button class="action-btn delete-btn" title="Disapprove User">Disapproved</button>
  								</a>
							</td>
